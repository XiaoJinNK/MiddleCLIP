...
class MiddleCLIPSegmentation(BaseSegmentor):
    def __init__(self, clip_path, name_path, device=torch.device('cuda'),
                 arch='wo_resi', attn_strategy='middleclip', gaussian_std=5., pamr_steps=0, use_rcs=True, use_sfr=True,
                 ...
                 shallow_layer_idx=None, shallow_fusion_weight=None, branch_fusion_weight=None, 
                 mid_layer=[], branch_layers_from_end=None, use_shallow_fusion=False, use_branch=False):
        ...
        self.net.visual.shallow_layer_idx = shallow_layer_idx
        self.net.visual.shallow_fusion_weight = shallow_fusion_weight
        self.net.visual.branch_fusion_weight = branch_fusion_weight
        self.net.visual.mid_layer = mid_layer
        self.net.visual.branch_layers_from_end = branch_layers_from_end
        self.net.visual.use_shallow_fusion = use_shallow_fusion
        self.net.visual.use_branch = use_branch
